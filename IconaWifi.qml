...
//    anchors.centerIn: parent
    scale: component.width/350
    anchors.topMargin: height*-0.6
    anchors.leftMargin: width*-0.6

    ShapePath {

        Component.onCompleted: console.log("w: ",width)
        id: svg
...
Shape
{
    ...
    ShapePath {
        ...
        startX: .2*component.width
        startY: .2*component.width
        PathLine { x: .8*component.width; y: .8*component.width }
